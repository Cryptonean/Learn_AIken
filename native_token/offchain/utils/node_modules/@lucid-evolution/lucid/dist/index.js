...
var selectionAndEvaluation = (config, walletInputs, changeAddress, coinSelection, localUPLCEval, script_calculation) => Effect16.gen(function* () {
...
var doCoinSelection = (config, availableInputs, script_calculation) => Effect16.gen(function* () {
  const estimatedFee = {
...
var recursive = (inputs, requiredAssets, coinsPerUtxoByte, externalAssets = {}, error) => Effect16.gen(function* () {
  let selected = [];
