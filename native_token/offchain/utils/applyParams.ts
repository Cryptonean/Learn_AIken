...
//
const utxoRef: any = new Constr(0, ["7103cd0400f406324cc4456364288262e090b4a4fd52d471d7e9c128f666bb9a", BigInt(1)]);  // BigInt(0) = id of transaction
const tokenName: string = ("506f6b656d6f6e");   
